                        ...
                        <CardContent>
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div>
                              ...
                              <p className="font-semibold text-green-600">${selectedOrder.total}</p>
                            </div>
                            <div>
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                              <h3 className="text-xl font-semibold">{selectedOrder.customer.name}</h3>
                              ...
                              <div className="space-y-2">
                                ...
                                {selectedOrder.estimatedDelivery && (
                                  <>
                                    ...
                                    <p className="font-semibold">{formatDate(selectedOrder.estimatedDelivery)}</p>
                                  </>
                                )}
                              </div>
                            </div>
